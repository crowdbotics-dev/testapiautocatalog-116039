...
## Project Structure
    ...
    ├── testapiautocatalog_116039  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_116039`
...
2. Clone this repo and `cd testapiautocatalog_116039`
